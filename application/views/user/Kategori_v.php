<div class="container-fluid">
  <!-- Navbar Kategori -->
  <nav class="navbar navbar-expand-lg shadow navbar-light bg-light mt-3 mb-3">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse justify-content-center" id="kategori">
        <ul class="navbar-nav mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link" aria-current="page" href="<?php echo base_url('Beranda/Allproduk/') ?>">All Product</a>
          </li>
          <?php $kategori = $this->Beranda_m->tampil_data_kategori(); ?>
          <?php foreach ($kategori as $key => $value) { ?>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url('Beranda/kategori/' . $value->id_kategori) ?>"><?php echo $value->kategori ?></a>
            </li>
          <?php } ?>
        </ul>
      </div>
